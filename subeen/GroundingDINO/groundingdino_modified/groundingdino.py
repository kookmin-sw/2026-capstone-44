...
class GroundingDINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, targets: List = None, **kw):
        ...
        # caption 끝 punctuation 보정 (mask 생성 안정화)
        captions = [cap if cap.strip().endswith(".") else cap + " ." for cap in captions]
